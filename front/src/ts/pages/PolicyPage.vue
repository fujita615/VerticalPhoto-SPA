<template>
    <div class="p-standard">
        <div class="p-standard__container">
            <h2 class="c-medium-heading c-medium-heading--section">当サイトについて</h2>
            <!-- 注意書きコンポーネント -->
            <CautionaryNote />
            <br />
            <!-- クッキーポリシーコンポーネント -->
            <CookiePolicy />
            <h3 class="c-sub-heading c-sub-heading--article">個人情報保護方針</h3>
            <p class="c-paragraph c-paragraph--article">
                VerticalPhoto（以下，「当サイト」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，
                ...
                当サイトは，ユーザーが利用登録をする際に氏名，メールアドレスなどの個人情報をお尋ねすることがあります。
                <br />
                <strong>第3条（個人情報を収集・利用する目的）</strong><br />

                当サイトが個人情報を収集・利用する目的は，以下のとおりです。<br />
                当サイトサービスの提供・運営のため<br />
                ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）<br />
                ユーザーが利用中のサービスのメンテナンス，重要なお知らせなど必要に応じたご連絡のため<br />
